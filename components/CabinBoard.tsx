          ...
          <div className="bg-[#fafaf8] rounded-3xl p-8 max-w-md w-full shadow-2xl max-h-[90vh] overflow-y-auto">
            ...
            {errorMessage && (
              <div className="mb-4 bg-red-50 border border-red-200 rounded-2xl p-4">
                <p className="text-sm text-red-800 font-medium mb-2">Error creating post:</p>
                <p className="text-sm text-red-800">{errorMessage}</p>
                <p className="text-xs text-red-600 mt-3 font-medium">Troubleshooting:</p>
                <ul className="text-xs text-red-600 mt-1 ml-4 list-disc">
                  <li>Check that NEXT_PUBLIC_SUPABASE_URL and NEXT_PUBLIC_SUPABASE_ANON_KEY are set in Vercel</li>
